...
public class CacheConfig {
    ...
    /**
     * RedisTemplate para operações diretas com Redis (necessário para IntelligentCacheService)
     */
    @Bean
    ...
    /**
     * StringRedisTemplate para operações com strings (usado nos diagnósticos)
     */
    @Bean
